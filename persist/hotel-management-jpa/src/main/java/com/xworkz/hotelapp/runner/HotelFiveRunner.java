...
//        HotelFiveEntity hotelFive = new HotelFiveEntity();
//        hotelFive.setId(2);
//        hotelFive.setHotelName("Monsoon");
//        hotelFive.setLocation("Sagar");
//        hotelFive.setRating(5.0);
//        hotelFive.setContact(88978232423L);
//        hotelFive.setHasParking(false);
//        hotelFive.setAverageCostForTwo(200.00);
//        hotelFive.setType(HotelType.veg);
